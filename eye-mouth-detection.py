...
while True:
    ...
    if results.detections is not None:
        for detection in results.detections:
            ...
            # Se convierten escala de grises
            ...
            # Se dibuja el bounding box del ojo derecho en la imagen
            cv2.rectangle(frame, (x_RET, y_min), (x_NT, y_NT-15), (0, 255, 0), 2)
            ...
            if current_time - start_time >= 0.5:
                ...
                img_name = f"ojo_stndr_{img_counter}.png"
                img_name2 = f"boca_stndr_{img_counter}.png"

                cv2.imwrite(os.path.join(output_dir, img_name), gray_eye)
                cv2.imwrite(os.path.join(output_dir2, img_name2), gray_mouth)

                print(f"Imagen estandarizada guardada como '{img_name}'")
                print(f"Imagen estandarizada guardada como '{img_name2}'")
                img_counter += 1
